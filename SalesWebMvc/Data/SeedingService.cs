...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department(2, "Èlectronics");
            ...
            SalesRecord r2 = new SalesRecord(2, new DateTime(2018, 9, 4), 7000.0, SalesStatus.Billed, s5);
            SalesRecord r3 = new SalesRecord(3, new DateTime(2018, 9, 13), 4000.0, SalesStatus.Canceled, s4);
            SalesRecord r4 = new SalesRecord(4, new DateTime(2018, 9, 1), 8000.0, SalesStatus.Billed, s1);
            SalesRecord r5 = new SalesRecord(5, new DateTime(2018, 9, 21), 3000.0, SalesStatus.Billed, s3);
            SalesRecord r6 = new SalesRecord(6, new DateTime(2018, 9, 15), 2000.0, SalesStatus.Billed, s1);
            SalesRecord r7 = new SalesRecord(7, new DateTime(2018, 9, 28), 13000.0, SalesStatus.Billed, s2);
            SalesRecord r8 = new SalesRecord(8, new DateTime(2018, 9, 11), 4000.0, SalesStatus.Billed, s4);
            SalesRecord r9 = new SalesRecord(9, new DateTime(2018, 9, 14), 11000.0, SalesStatus.Pending, s6);
            SalesRecord r10 = new SalesRecord(10, new DateTime(2018, 9, 7), 9000.0, SalesStatus.Billed, s6);
            SalesRecord r11 = new SalesRecord(11, new DateTime(2018, 9, 13), 6000.0, SalesStatus.Billed, s2);
            SalesRecord r12 = new SalesRecord(12, new DateTime(2018, 9, 25), 7000.0, SalesStatus.Pending, s3);
            SalesRecord r13 = new SalesRecord(13, new DateTime(2018, 9, 29), 10000.0, SalesStatus.Billed, s4);
            SalesRecord r14 = new SalesRecord(14, new DateTime(2018, 9, 4), 3000.0, SalesStatus.Billed, s5);
            SalesRecord r15 = new SalesRecord(15, new DateTime(2018, 9, 12), 4000.0, SalesStatus.Billed, s1);
            ...
            SalesRecord r29 = new SalesRecord(29, new DateTime(2018, 10, 13), 12000.0, SalesStatus.Billed, s5);
            ...
            _context.SalesRecord.AddRange(
                ...
                r11, r12, r13, r14, r15, r16, r17, r18, r19, r29,
